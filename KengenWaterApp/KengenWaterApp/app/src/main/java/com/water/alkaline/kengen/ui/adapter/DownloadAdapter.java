...
public class DownloadAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public DownloadAdapter(Activity activity, List<DownloadEntity> arrayList, OnDownloadListener listener) {
    ...
    public void refreshAdapter(List<DownloadEntity> arrayList) {
        this.arrayList = arrayList;
        setAds();
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ViewHolder) {
            ...
            viewHolder.binding.txtVideoTitle.setText(arrayList.get(position).name);
