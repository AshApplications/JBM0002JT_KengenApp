...
@Database(entities = {Category.class, Subcategory.class, Channel.class, Pdf.class, Banner.class, DownloadEntity.class, SaveEntity.class}, version = 1, exportSchema = false)
