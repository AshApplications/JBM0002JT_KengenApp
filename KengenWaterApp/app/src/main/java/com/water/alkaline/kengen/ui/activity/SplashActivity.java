...
public class SplashActivity extends AppCompatActivity {
    ...
    public void nextActivity() {
        ...
        FirebaseMessaging.getInstance().subscribeToTopic(PowerPreference.getDefaultFile().getString(Constant.notifyKey, "swaminarayan")).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
